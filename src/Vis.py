# *-------------------------------------------------------------------------*/
# *                                                                         */
# *    Copyright (c) Innovation First 2019-2022, All rights reserved.       */
# *                                                                         */
# *    Module:     vex.py                                                   */
...
# allows debuging of python code
# version: 20220822_1800_01
#
# ----------------------------------------------------------
...
class Brain:
    ...
    class Lcd:
        ...
        def set_origin(self, x: vexnumber, y: vexnumber):
            '''### Set the origin used for drawing graphics on the screeno alte
        ...
        def draw_rectangle(self, x: vexnumber, y: vexnumber, width: vexnumber, height: vexnumber, color: Any=None):
            ...
            #### Arguments:
                ...
                color (optional) : An optional fill color, the current fill color will be used if not suppplied
    ...
    class Battery:
        ...
        def temperature(self, units: TemperaturePercentUnits = PercentUnits.PERCENT):
            ...
            #### Arguments:
                units (optional) : PERCENT, CELCIUS or FAHRENHEIT, default is CELCIUS
...
class Event:
    ...
    More than one function can be assinged to a single event.
...
class Gps:
    ...
    def set_sensor_rotation(self, value, units=RotationUnits.DEG):
        '''### set the sensor rotation of the gps sensor with respect tothe robot.
...
class Motor:
    ...
    def spin_to_position(self, rotation: vexnumber, *args, **kwargs):
        ...
        #### Arguments:
            ...
            wait (optional) : This indicates if the function should wait for the command to complete or return immeadiately, default is True.
    ...
    def spin_for(self, direction: DirectionType.DirectionType, rot_or_time: vexnumber, *args, **kwargs):
        ...
        Move the motor to the requested position or for the specified amout of time.\\
    ...
    def is_spinning(self):
        ...
        It will return True if the motor is still spinning or False if it has completed the move or a timeout occured.
    ...
    def is_done(self):
        '''### Returns the current status of the spin_to_position or spin_for command
        This function is used when False has been passed as the wait parameter to spin_to_position or spin_for\\
        It will return False if the motor is still spinning or True if it has completed the move or a timeout occured.
    ...
    def temperature(self, *args):
        ...
        #### Arguments:
            units (optional) : The units for the returned temperature, the default is CELCIUS
...
class Timer:
    ...
    A timer can be used to measure time, access the system time and run a funtion at a time in the future.
    ...
    def time(self, units=TimeUnits.MSEC):
        ...
        #### Arguments:
            units (optional) : the units that the time shound be returned in, default is MSEC
...
class Encoder:
    ...
    def velocity(self, units=VelocityUnits.RPM):
        ...
        #### Arguments:
            units (optional) : The velociyt units to return the position value in, default is RPM.
...
class Motor29:
    ...
    def set_velocity(self, value, units=VelocityUnits.RPM):
        '''### Set default velocity for the motor
...
class MessageLink:
    ...
    def received(self, *args):
        ...
        If the message is ommitted then the callback will be called for all messages.
...
class Rotation:
    ...
    def set_reversed(self, value):
        '''### Set the reveraed flag for the sensor
...
class Electromagnet:
    ...
    def pickup(self, duration=1000, units=MSEC, power=50):
        ...
        #### Arguments:
            duration (optional) : the duration to energize the magner for, default is 1 second
...
# ----------------------------------------------------------------------------
    def set_position(self, value, units=None):
        '''### Set the current position for all kotors in the group
        The position returned by the position() function is set to this value.
...
# ----------------------------------------------------------------------------
    def spin_to_position(self, rotation, units=RotationUnits.DEG,
                         velocity=None, units_v=VelocityUnits.RPM, wait=True):
...
# ----------------------------------------------------------------------------
    def spin_for(self, direction, rotation, units=RotationUnits.DEG,
                 velocity=None, units_v=VelocityUnits.RPM, wait=True):
...
# ----------------------------------------------------------------------------
    def is_spinning(self):
        '''### Returns the current status of the spin_to_position or spin_for command
        This function is used when False has been passed as the wait parameter to spin_to_position or spin_for\\
        It will return True if any motor is still spinning or False if they have completed the move or a timeout occured.
...
# ----------------------------------------------------------------------------
    def is_done(self):
        '''### Returns the current status of the spin_to_position or spin_for command
        This function is used when False has been passed as the wait parameter to spin_to_position or spin_for\\
        It will return False if any motor is still spinning or True if they have completed the move or a timeout occured.
...
# ----------------------------------------------------------------------------
    def set_max_torque(self, value, units=TorqueUnits.NM):
...
# ----------------------------------------------------------------------------
    def drive(self, direction, velocity=None, units=VelocityUnits.RPM):
...
# ----------------------------------------------------------------------------
    def turn(self, direction, velocity=None, units=VelocityUnits.RPM):
...
# ----------------------------------------------------------------------------
    def is_moving(self):
        ...
        It will return True if the drivetrain is still moving or False if it has completed the move or a timeout occured.
...
# ----------------------------------------------------------------------------
    def is_done(self):
        '''### Returns the current status of the drive_for or turn_for command
        This function is used when False has been passed as the wait parameter to drive_for or turn_for\\
        It will return False if the drivetrain is still moving or True if it has completed the move or a timeout occured.
